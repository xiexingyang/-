<template>
  <div class="context">
    ...
    <el-table :data="datalist" border>
      ...
      <el-table-column label="更新状态" width="100px">
        <template slot-scope="scope">
          <div  v-if="scope.row.isend == 1">已完结</div>
          <div class="updata_status"  v-if="scope.row.isend == 0" >连载中</div>
        </template>
      </el-table-column>
      <el-table-column
        label="订阅量"
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
            <el-button type="warning" @click="gomulu(scope.row)">目录</el-button>
